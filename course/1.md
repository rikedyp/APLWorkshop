...
2. Pyramid Schemes
    1. Sugar cubes are stacked in an arrangement as shown by **figure 1**.
		...
		![Figure 1. Stacked sugar cubes](/img/SquaredCubes.png){: width="200px"}
    ...
    1. Now consider the stack in **figure 2**.
		...
		![Figure 2. Differently stacked sugar cubes](/img/OddSquaredCubes.png){: width="280px"}
    ...
    1. Now look at **figure 3**.
		...
		![Figure 3. This is just a waste of sugar cubes by now...](/img/CubedCubes.png){: width="280px"}
