...
1. Monthly Sales
    You are given a vector of sales data for `5` products over `2` years. The first `12` elements are sale for the first product for the first year, the second `12` elements represent sales of the 2nd product in the first year, and so on.
